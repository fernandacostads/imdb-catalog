...
public enum DirectorMessage {
  LIST_NOT_FOUND(
    Colors.RED + "No directors found. Returning to the view..." + Colors.RESET
  ),
  ...
  DIRECTOR_ID_NOT_FOUND(
    Colors.RED + "No director found with the specified ID." + Colors.RESET
  ),
  DIRECTOR_FOUND_NAME(
    Colors.RED + "No director found with the specified name." + Colors.RESET
  ),
  ...
  ENTER_SEARCH_KEYWORD_DIRECTOR(
    "Enter the name keyword to search for a director: "
  ),
  ENTER_DIRECTOR_NAME("Enter the name of the director: "),
  ENTER_DIRECTOR_NATIONALITY("Enter the nationality of the director: "),
  ENTER_DIRECTOR_BIRTHDATE(
    "Enter the birthdate of the director (XXXX-XX-XX): "
  );
